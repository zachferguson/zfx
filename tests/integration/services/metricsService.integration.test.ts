 ...
 *
 * Two suites:
 * 1) pg-mem (always): service wired to an in-memory pg instance via a mocked db module.
 ...
 * - Real DB: the above behaviors within a tx and rolled back (no side effects)
 */
